<?php $__env->startSection('content'); ?>
    <div class="container py-5">
        <div class="card px-4 py-4 mx-auto border border-primary" style="width: 40vw">
            ...
            <form action="<?php echo e(route('loginPage')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/2A1CF1811CF147F9/projects/Laravel/laravelAuth/resources/views/login.blade.php ENDPATH**/ ?>